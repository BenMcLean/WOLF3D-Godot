...
namespace WOLF3D.WOLF3DGame.Action
{
	public abstract class FourWalls : Pushable, ISavable
	{
		...
		{
			Name = "FourWalls";
			AddChild(Sides[DirectionIndex(Direction8.EAST)] = Walls.BuildWall(darkSide, false, 1, 0));
			AddChild(Sides[DirectionIndex(Direction8.SOUTH)] = Walls.BuildWall(wall, true, 0, 0));
			AddChild(Sides[DirectionIndex(Direction8.WEST)] = Walls.BuildWall(darkSide, false, 0, 0, true));
			AddChild(Sides[DirectionIndex(Direction8.NORTH)] = Walls.BuildWall(wall, true, 0, -1, true));

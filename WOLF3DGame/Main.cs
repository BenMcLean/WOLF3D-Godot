...
namespace WOLF3D.WOLF3DGame
{
    public class Main : Node
    {
        ...
        public static ColorRect ColorRect
        {
            ...
            {
                if (colorRect != null)
                    I.GetViewport().RemoveChild(colorRect);
                colorRect = value;
                if (colorRect != null)
                {
                    I.GetViewport().AddChild(colorRect);
                    I.UpdateFadeSize();
                }
            }
        }
        private static ColorRect colorRect;
        public void UpdateFadeSize() => ColorRect.RectSize = GetViewport().Size;
        ...
        public override void _Ready()
        {
            ...
            {
                Name = "Fade",
                Color = Color.Color8(0, 0, 0, 0),
                RectSize = GetViewport().Size,
            };
            GetViewport().Connect("size_changed", this, nameof(UpdateFadeSize));
